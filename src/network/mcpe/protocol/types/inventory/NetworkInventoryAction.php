...
class NetworkInventoryAction{
	...
	public function readAuthInput(ByteBufferReader $in) : NetworkInventoryAction{
		...
		$this->oldItem = CommonTypes::getItemStackWrapper($in, ProtocolInfo::PROTOCOL_1_26_20);
		$this->newItem = CommonTypes::getItemStackWrapper($in, ProtocolInfo::PROTOCOL_1_26_20);
	...
	public function writeAuthInput(ByteBufferWriter $out) : void{
		...
		CommonTypes::putItemStackWrapper($out, $this->oldItem, ProtocolInfo::PROTOCOL_1_26_20);
		CommonTypes::putItemStackWrapper($out, $this->newItem, ProtocolInfo::PROTOCOL_1_26_20);
	}
