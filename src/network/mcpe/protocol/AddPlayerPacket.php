...
class AddPlayerPacket extends DataPacket implements ClientboundPacket{
	...
	protected function decodePayload(ByteBufferReader $in, int $protocolId) : void{
		...
		$this->item = $protocolId >= ProtocolInfo::PROTOCOL_1_26_40 ? CommonTypes::getNetworkItemStackDescriptor($in, $protocolId) : CommonTypes::getItemStackWrapper($in, $protocolId);
